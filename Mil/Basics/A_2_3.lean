...
--
-- На примере цепочек неравенств (le_trans, lt_of_le_of_lt и тому
-- подобных) показывается, как из нескольких лемм собрать одно
-- составное доказательство, и обсуждается, чем явное указание
...
-- применить автодополнение по префиксу имени и тактики apply?/exact?,
-- которые перебирают библиотеку в поисках леммы, закрывающей текущую
-- цель.
